...
INICIO
 ...
 ; MOVF PORTB
  ...
  GOTO TITILO ;Va a TITILO
  MOVF BX,0 ;Como no se ejecuto, mueve el valor de BX a W
  MOVWF PORTA ;Mueve el valor de W a PORTA
  GOTO INICIO ;Vuelve a INICIO

TITILO ;Como hay carry tiene que titilar otro LED
  BSF PORTA,4 ;Setea en 1 el bit de la posicion 4 de PORTA
LAZO  
  MOVLW 0X06 ;Mueve 00000110 (6) a W
  MOVWF CONT3 ;Mueve el valor de W a CONT3
LAZO3
  MOVLW 0XD7 ;Mueve 11011001 (217) a W
...
LAZO1
  ...
  DECFSZ CONT3,1 ;Se decrementa el valor de CONT3 y se guarda en CONT3, hasta que sea 0
